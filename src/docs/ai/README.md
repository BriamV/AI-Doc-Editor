...
- **Linting**: `yarn lint` with ESLint
- **Formatting**: `yarn format` with Prettier
...
*This implementation documentation follows Conway's Law principles, keeping technical details close to the code they describe. For strategic architecture decisions, see [AI Architecture](../../../docs/architecture/ai/).*