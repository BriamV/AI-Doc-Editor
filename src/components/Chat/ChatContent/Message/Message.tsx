...
// Custom hook for handling message height changes
const useMessageHeightObserver = () => {
...
// Component for last message with fixed positioning
const LastMessage = ({
  role,
  content,
  messageIndex,
  ...
  const heightRef = useMessageHeightObserver();
...
const Message = React.memo(
  ({
    ...
    const commonProps = { role, content, messageIndex, sticky, hideSideMenu };

    return isLastMessage ? <LastMessage {...commonProps} /> : <RegularMessage {...commonProps} />;
  }
);
