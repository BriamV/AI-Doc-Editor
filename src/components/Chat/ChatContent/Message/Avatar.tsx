  ...
  ({
    ...
    return (
      <div className="w-full flex flex-col relative items-center">
        {role === 'user' && (
          <UserAvatar role={role} content={content} messageIndex={messageIndex} sticky={sticky} />
        )}
        {role === 'assistant' && (
          <AssistantAvatar
            role={role}
        ...
        {role === 'system' && (
          <SystemAvatar role={role} content={content} messageIndex={messageIndex} sticky={sticky} />
        )}
      </div>
    );
  }
