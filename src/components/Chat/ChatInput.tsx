...
const ChatInput = () => {
  return (
    <div className="w-full border-t md:border-t-0 dark:border-white/10 md:border-transparent md:dark:border-transparent md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient">
