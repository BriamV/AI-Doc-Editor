...
const PromptLibraryMenuPopUp = ({
  ...
  return (
    <PopupModal title={t('promptLibrary') as string} setIsModalOpen={setIsModalOpen}>
      <div className="p-6 border-b border-gray-200 dark:border-gray-600 w-[90vw] max-w-full text-sm text-gray-900 dark:text-gray-300">
        ...
        <div className="flex flex-col py-2 max-w-full" ref={container}>
          ...
          {_prompts.map((prompt, index) => (
            <div key={prompt.id} className="flex items-center border-b border-gray-500/50 mb-1 p-1">
              ...
              <div className="cursor-pointer w-16 flex items-center justify-center">
                <PromptConfig
                  prompt={prompt}
                  index={index}
