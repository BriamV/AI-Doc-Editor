...
export const PromptButtonConfig = (
    {
        prompt, index, _promptName, _setPromptName
    }:
    {
        prompt: any;
        index: number;
    ...
    return (
        ...
        <PromptPopup setIsModalOpen={setIsPromptConfigModalOpen} prompt={prompt} index={index} _promptName={_promptName} _setPromptName={_setPromptName} />
        ) : (<></>)
        }
        </>
    )
...
const handleInput = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
  ...
  return (
     ...
     >
     <div 
     className='p-6 border-b border-gray-200 dark:border-gray-600 w-full'>
        <div className='flex mb-4 flex-col'>
            <div className='mb-2'>
            <span
            className='text-white'>Name:</span>
            <textarea
