...
# QA CLI System (R0.WP6 Completed - T-13, T-14, T-15)
yarn run cmd qa                           # Automatic validation
yarn run cmd qa --fast                    # Fast mode (pre-commit)
yarn run cmd qa --dod=code-review        # Definition of Done validation
yarn run cmd qa --scope=frontend         # Scope-specific validation
yarn run cmd qa --dimension=security     # Single dimension
yarn run cmd qa --report-issue           # Report problems (RF-008)
# 📚 Full documentation: docs/qa-cli/
...
# QA CLI System (Specialized Documentation)
docs/qa-cli/README.md: System overview, R0.WP6 completion status
docs/qa-cli/user-guide.md: User cases, examples, workflows
docs/qa-cli/workflow-integration.md: T-13 (DoD), T-14 (CI/CD), T-15 (Feedback)
docs/qa-cli/api-reference.md: Commands, flags, configuration reference
docs/qa-cli/troubleshooting.md: Common problems and solutions
docs/PRD-QA CLI.md: Complete system specifications
docs/QA-SETUP-GUIDE.md: Environment setup and installation
...
QA System: docs/PRD-QA CLI.md → docs/qa-cli/* → scripts/qa/*
```
