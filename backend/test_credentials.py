...
class TestCredentialsService:
    ...
    def test_openai_key_validation(self):
        ...
        # Valid keys
        assert credentials_service.validate_openai_key_format("sk-test1234567890abcdef1234567890abcdef123456")
        ...
        assert not credentials_service.validate_openai_key_format("pk-test123456789")  # wrong prefix
...
class TestCredentialsAPI:
    ...
    def test_store_credentials_invalid_format(self):
        ...
        for invalid_key in invalid_keys:
            response = client.post(
                ...
                # headers={"Authorization": "Bearer mock-token"}  # Would need mock auth
            )
            # Would expect 400 or 401 depending on auth implementation
    ...
    def test_credentials_endpoints_require_auth(self):
        ...
        assert response.status_code in [401, 403, 422]  # 422 might be returned by FastAPI for missing deps
